      ...
      return (
        <ThemeProvider theme={theme}>
            ...
            <main>
                ...
                <ol>
                  <li>The process you used to generate this set of contexts. How did you select this process?</li>
                  <li>Why is this set of contexts representative of your use case? Justify the connection of these contexts to the model's intended use.</li>
                </ol>

                <Typography paragraph>
                  Note, this is not an exhaustive list. However, you should make sure your explanation touches upon at 
                  least the points mentioned above. Please add any other details you feel are useful. 
                </Typography>
                ...
                >
                    ...
                    multiline rows={5} fullWidth label="justification" id="justification" 
                    onChange={ (event) => {
      ...
      >
        <Stack
          ...
          >
            ...
            <Typography paragraph>{this.state.contexts[this.state.selectedContext]}</Typography>
            <Typography paragraph>{this.state.contextsData[this.state.selectedContext]}</Typography>
