...
class docResults extends Component {
    ...
    createRows(){
        ...
        for(var i = 0; i < this.state.ModelInfo.contextNames.length; i++) {
            array.push(this.createData(this.state.ModelInfo.contextNames[i], this.state.ModelInfo.humanResponses[i], this.state.ModelInfo.predictions[i], this.state.ModelInfo.metricOne[i], this.state.ModelInfo.metricTwo[i]))
        }
        ...
        <ThemeProvider theme={theme}>
            ...
            <main>
                ...
                <TextField 
                    ...
                    multiline rows={3} fullWidth label="Process Justification" id="ProcessJustification" 
                    onChange={ (event) => {
                ...
                />
                <Typography variant="h6">
                   Here, you have created a model of an AI system. Think about how you generated your responses. 
                   Why can you justify deployment in this situation?  
                </Typography>
                <TextField 
                    inputProps={ {
                        cols: "50"
                    }}
                    multiline rows={3} fullWidth label="Deployment Justification" id="DeploymentJustification" 
                    onChange={ (event) => {
