...
// todo: come back and import the model
...
class ViewDoc extends Component {
	constructor(props) {
		...
		this.state = {
			...
			id: undefined,
			selectedContext: 0,
            // todo when reimporting model, come back and fix this.
			avgSimScore:0,
						...
						>
							...
							>
								<Typography variant="h6">
									{" "}
									You have entered [N/A NEED TO COME BACK WHEN CONNECTING MODEL]{
							...
							<Typography paragraph>
                                COME BACK HERE WHEN REIMPORTING MODEL
							...
							<Typography variant="h6">
								{" "}
								You have entered [COME BACK HERE WHEN REIMPORTING MODEL]
                                {/*this.state.ModelInfo.contextNames.length*/}{" "}
								contexts
							</Typography>
							<Typography variant="h6">
